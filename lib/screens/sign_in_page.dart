            ...
            Padding(
              ...
              child: ElevatedButton(onPressed: () async{
                ...
                if(emptyKeys(_textFields)){
                  ...
                  List<String>? userInfo = sp.getStringList(widget.username);
                  for(var i in _textFields.keys){
                    userInfo!.add(_textFields[i]!.text);
                  }
                  userInfo![3] = "false";
                  sp.setStringList(widget.username, userInfo);
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> HomePage(title: "Title", username: widget.username)));
                }
